...
- 约束：
  ...
  * 检测时间为投放时间后一周
- 输出：当前目录生成 gdcb_survival_data.json，数组JSON，key为中文字段名
*/

const fs = require('fs');
const code='GDCB';
const FISH_TYPE = '光倒刺鲃';

// 配置参数
const START_DATE = new Date('2024-06-05');
const END_DATE = new Date('2025-07-20');
// 生成上限（520-580之间随机）
...
function main() {
  ...
  const outPath = './gdcb_survival_data.json';
