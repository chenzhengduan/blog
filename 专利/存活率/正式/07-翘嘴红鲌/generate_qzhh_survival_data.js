...
- 约束：
  ...
  * 检测时间为投放时间后一周
- 输出：当前目录生成 qzhh_survival_data.json，数组JSON，key为中文字段名
*/

const fs = require('fs');
const code='QZHB';
const FISH_TYPE = '翘嘴红鲌';

// 配置参数
const START_DATE = new Date('2024-05-30');
const END_DATE = new Date('2025-07-31');
// 生成上限（可按需调整），满足"500+且<600"
const MAX_RECORDS = 550;
...
function main() {
  ...
  const outPath = './qzhh_survival_data.json';
