...
- 约束：
  ...
  * 检测时间为投放时间后一周
- 输出：当前目录生成 gy_survival_data.json，数组JSON，key为中文字段名
*/
...
// 配置参数
const START_DATE = new Date('2024-05-15');
const END_DATE = new Date('2025-07-31');
// 生成上限（可按需调整），满足"500+且<600"
const MAX_RECORDS = 520;
...
function main() {
  ...
  const outPath = './gy_survival_data.json';
