...
![](/_next/static/media/text.6029c0fb.gif)
...
在 `TextGeometry` 的构造函数中，我们需要传入两个参数：文本字符串和配置对象。

##### **参数 1：文本字符串**[](#参数-1文本字符串)
...
![](/_next/static/media/text.6b01f04c.png)
