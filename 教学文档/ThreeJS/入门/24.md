...
## 2\. Three.js 中使用 Shader 的基本流程[](#2-threejs-中使用-shader-的基本流程)
...
![](/_next/static/media/shader.e98b22d6.png)
...
在这个示例中，你会看到平面左侧呈蓝色，向右渐变到红色。如果你想要让渐变方向竖直显示，可以用 `position.y` 来做插值。 ![](/_next/static/media/shader1.4d16fb8b.png)

## 4\. 传递 Uniforms[](#4-传递-uniforms)
...
这样，颜色就会随着 `uTime` 的变化而产生动态波动。 ![](/_next/static/media/shader3.9228ee82.gif)
...
[体积光](/concepts/basic/godray "体积光")[实现描边发光效果](/concepts/basic/effect "实现描边发光效果")