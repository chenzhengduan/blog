...
![](/_next/static/media/texture.0e059230.png)
...
![](/_next/static/media/texture-2.e8d0a2be.png) 适用场景：
...
![](/_next/static/media/texture-3.40c289c7.png) 适用场景：
...
![](/_next/static/media/texture-5.be7f0748.png) 适用场景：
...
![](/_next/static/media/texture-7.7ae6d1d9.png) 适用场景：
...
![](/_next/static/media/texture-8.0e4e2d24.png) 适用场景：
...
![](/_next/static/media/texture-9.cf5f8dec.png) 适用场景：
...
![](/_next/static/media/texture-10.c6ba7797.png) 适用场景：
...
### 2\. **透明度（opacity 和 transparent）**[](#2-透明度opacity-和-transparent)
...
3.  **降低分辨率**：对于次要物体，使用低分辨率纹理。
4.  **简化光照计算**：在性能敏感的应用中，选择 `MeshBasicMaterial` 或 `MeshLambertMaterial`。
